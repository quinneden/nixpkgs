...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "quinneden";
    repo = "libkrunfw";
    rev = "refs/heads/macos-native-build";
    hash = "sha256-ToJOi4opnZKTVJT044VcWa6Z2vXXdIF/KVLDJjExPKQ=";
  };
  ...
  ++ lib.optionals (variant == "sev") [ "SEV=1" ]
  ++ lib.optionals (variant == "tdx") [ "TDX=1" ]
  ++ lib.optionals stdenv.hostPlatform.isDarwin [
    "KERNEL_MAKE=make"
